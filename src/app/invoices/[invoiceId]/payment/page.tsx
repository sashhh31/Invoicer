...
import { createPayment, UpdateServerAction } from "@/app/actions";
import { db } from "@/db";
...
export default async function InvoicePage({
  ...
  return (
    <main className="w-full h-full border-gray-900">
      <Container className=" border-gray-900">
        {isError && (
        ...
        <div className="grid grid-cols-2 border-gray-900">
          <div>
